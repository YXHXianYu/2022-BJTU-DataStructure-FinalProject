...
void MainWindow::on_btnGame_clicked() {
  ...
  gw->show();
  std::cerr << "MainWindow::on_btnGame_clicked - GameWindow has showed."
            << std::endl;
...
void MainWindow::on_btnGame_pressed() {
  ui->btnGame->setIcon(QIcon(":/images/mainwindow/4-.png"));
}
...
void MainWindow::on_btnRank_pressed() {
  ui->btnRank->setIcon(QIcon(":/images/mainwindow/5-.png"));
}
...
void MainWindow::on_btnConfig_pressed() {
  ui->btnConfig->setIcon(QIcon(":/images/mainwindow/6-.png"));
}
